...
function cleanHtml(msg){
  ...
  return `
    ...
    <div style="font-size:12px; color:#666; margin-top:20px; padding-top:10px; border-top:1px solid #ddd;">
      —<br>
      This message was sent securely from our system.<br>
      If you received this in error, please ignore it.
    </div>
  `;
}

// TEXT FALLBACK (NO FOOTER HERE)
